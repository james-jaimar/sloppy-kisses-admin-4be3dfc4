...
const SECTIONS = [
  ...
  { to: "/admin/shop-stock/barcode-capture", label: "Barcodes", description: "Scan items and attach codes to products, on the desk or by phone.", icon: Barcode, code: "pos.barcode.link" },
