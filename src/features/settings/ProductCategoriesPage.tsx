...
export default function ProductCategoriesPage() {
  ...
  const [draft, setDraft] = useState<Draft>({ name: "", sort_order: 100, active: true });
  ...
  async function save() {
    ...
    try {
      ...
      setDraft({ name: "", sort_order: 100, active: true });
    ...
    <>
      ...
      <div className="flex-1 p-6 space-y-4">
        <div className="flex justify-end">
          <button onClick={() => { setCreating(true); setEditingId(null); setDraft({ name: "", sort_order: 100, active: true }); }}
